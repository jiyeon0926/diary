...
|게시물 좋아요|POST|/boards/{boardId}/good|POST /boards/1/good HTTP/1.1</br>Content-Type: application/json</br>Cookie: JSESSIONID= ${sessionId}|||성공</br>200 OK||
...
|댓글 좋아요|POST|/boards/{boardId}/comments/{commentId}/good | POST /boards/1/comments/1/good HTTP/1.1</br>Content-Type: application/json</br>Cookie: JSESSIONID= ${sessionId}|||성공</br>200 OK</br></br>실패</br>400 Bad Request||
